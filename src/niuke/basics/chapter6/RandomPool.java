 ...
 * 哈希函数特性：
 * 1.输入域无穷大
 * 2.输出域是一个有穷（固定）区间，可以认为输入域远大于输出域
 * 3.输入一样，输出一定一样 （重要）
...
public class RandomPool<K> {
    ...
    public static void main(String[] args) {
        ...
        randomPool.insert("str1");
        randomPool.insert("str2");

        randomPool.delete("str1");
        System.out.println(randomPool.keyIndexMap);
        System.out.println(randomPool.IndexKeyMap);
